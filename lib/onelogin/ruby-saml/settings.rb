module Onelogin
  module Saml
    ...
    class Settings
      ...
      DEFAULTS = {:compress_request => true, :double_quote_xml_attribute_values => false, :time_range_validator => PermissiveTimeRangeValidator.new, :assertion_id_validator => PermissiveAssertionIdValidator.new}
    end
